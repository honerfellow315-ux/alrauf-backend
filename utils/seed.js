  ...
  try {
    ...
    if (!existingAdmin) {
      await User.create({
        name: 'ALRauf Admin',
        phone: '03363057013',
        email: 'alrauffragrance1@gmail.com',
    ...
    if (count === 0) {
      ...
      await Product.insertMany([
        ...
        {
          name: 'Wanted by Abdul Rauf',
          slug: 'wanted-by-abdul-rauf',
          description: 'Premium fragrance by ALRauf.',
          price: 2800,
          category: 'EDP',
          stock: 50,
          isFeatured: true,
...

        {
          name: 'Flora by Malka',
          slug: 'flora-by-malka',
          description: 'Elegant floral fragrance by ALRauf.',
          price: 4500,
          category: 'Attar',
          stock: 30,
          isFeatured: true,
